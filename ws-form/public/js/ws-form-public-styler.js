(function($) {
	...
	// Styler - Header HTML
	// Styler - SVG
	$.WS_Form.prototype.styler_svg = function(id) {

		var icons = (typeof window.wsf_form_json_config !== 'undefined' && typeof window.wsf_form_json_config.styler !== 'undefined' && typeof window.wsf_form_json_config.styler.icons !== 'undefined') ? window.wsf_form_json_config.styler.icons : {};

		return (typeof icons[id] !== 'undefined') ? icons[id] : '';
	}
	...
	$.WS_Form.prototype.styler_header_html = function() {
		...
		styler_html += this.styler_svg('logo');
		...
		if(return_url) {
			...
			styler_html += '<li data-wsf-styler-action="return" data-href="' + this.esc_attr(return_url) + '" title="' + this.esc_attr(this.styler_get_return_label()) + '">' + this.styler_svg('return') + '</li>';
		}

		styler_html += '<li data-wsf-styler-action="undo" title="' + this.language('styler_undo') + '">' + this.styler_svg('undo') + '</li>';
		styler_html += '<li data-wsf-styler-action="settings" title="' + this.language('styler_settings') + '">' + this.styler_svg('settings') + '</li>';
		styler_html += '<li data-wsf-styler-action="save" title="' + this.language('styler_save') + '">' + this.styler_svg('save') + '</li>';
		styler_html += '<li title="' + this.language('styler_support') + '"><a href="https://wsform.com/knowledgebase/styler/?utm_source=ws_form_pro&utm_medium=styler" target="_blank">' + this.styler_svg('question-circle') + '</a></li>';
	...
	$.WS_Form.prototype.styler_var_column_html = function(styler_var, alt, group_focus_selector) {
		...
		if(alt) {
			...
			styler_html += '<div class="wsf-styler-var-top-icon" data-wsf-styler-var-action="alt" title="' + this.language('styler_alt_title') + '">' + this.styler_svg('wand') + '</div>';
		}

		// Copy
		styler_html += '<div class="wsf-styler-var-top-icon" data-wsf-styler-var-copy="' + this.esc_attr(css_var) + '" title="' + this.language('styler_copy') + ' ' + this.esc_attr(css_var) + '">' + this.styler_svg('copy') + '</div>';

		// Undo
		styler_html += '<div class="wsf-styler-var-top-icon" data-wsf-styler-var-action="undo" title="' + this.language('styler_undo') + '" data-wsf-styler-var-undo="' + this.esc_attr(value) + '">' + this.styler_svg('undo') + '</div>';
